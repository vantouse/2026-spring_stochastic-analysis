...
В модели FHN при значении параметра $a > 1$ равновесие $(x, y) = (0, 0)$ устойчиво. На основе симуляции длительностью $T = 100$ с шагом по времени $h = 0.01$ построим облако траекторий, вычислим матрицу ковариации и изобразим эмпирическую зависимость $\overline{\lambda_1}(a), \overline{\lambda_2}(a)$ (Рис. \ref{fig:eigenvalues_empirical_FHN}).
